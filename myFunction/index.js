...
const MONGODB_URI =
  "mongodb+srv://admin:admin123@uploader.6lpdw.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
async function connectToDatabase() {
  ...
  const db = await client.db("Uploader");
  cachedDb = db;
  return db;
}
...
exports.handler = async (event, context) => {
  ...
  const response = {
    statusCode: 200,
    body: JSON.stringify(image_uploads),
  };
  return response;
};
